...
t("nothing missing → null", needsOf(act("ours_pay", tax(true, "1RT1", "1TQ1")), "CA") === null);
...
t(
  "tax only when payment is settled",
  nTaxOnly?.tax === true && nTaxOnly?.bank === false,
  JSON.stringify(nTaxOnly),
);
